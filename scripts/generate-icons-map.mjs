#!/usr/bin/env node
// ESM script to parse src/shared/assets/icons and generate a TypeScript icons map.
// - Looks for `src/shared/assets/icons/outline` and `src/shared/assets/icons/solid`
// - For each SVG, extracts <path d="..."> entries and viewBox if possible
// - Falls back to raw markup if no <path> found
// - Writes to `src/shared/icons/icons.generated.ts`
...
const iconsDir = path.join(srcDir, 'shared', 'assets', 'icons');
const outFile = path.join(srcDir, 'shared', 'icons', 'icons.generated.ts');
...
async function generate() {
  ...
  const banner = `// Auto-generated by scripts/generate-icons-map.mjs. Do not edit.\n// Source: src/shared/assets/icons`;
