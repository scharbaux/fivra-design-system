...
/**
 * Storybook configuration for the Angular workspace using the Vite renderer.
 * Mirrors the React setup so shared aliases, addons, and production tweaks stay aligned.
 */
