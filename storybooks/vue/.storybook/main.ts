...
/**
 * Storybook configuration for the Vue workspace using the Vite renderer.
 * Mirrors the React and Angular setups so aliases, addons, and production tweaks stay aligned.
 */
